...
namespace GameBot.Game.Tetris.Extraction.Matchers
{
    ...
    {
        /// <summary>
        /// Gets the probability that a specific block on the board is occupied.
        /// </summary>
        /// <param name="screenshot">The screenshot.</param>
        /// <param name="x">The x coordinate of the block (in board coordinates).</param>
        /// <param name="y">The y coordinate of the block (in board coordinates).</param>
        /// <returns>The probability.</returns>
        double GetProbabilityBoardBlock(IScreenshot screenshot, int x, int y);
